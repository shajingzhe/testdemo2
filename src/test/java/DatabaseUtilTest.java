...
public class DatabaseUtilTest {
        ...
        private static final String DATABASE_URL = "jdbc:dm://192.168.0.105";
        private static final String USERNAME = "SYSDBA";
        private static final String PASSWORD = "dba@DM2021";
        private static final String SQL = "SELECT * FROM FZZX_KT.";// 数据库操作
        static {
            try {
